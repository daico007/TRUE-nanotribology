...
from ctools.lib.chains import Alkylsilane, PEGSilane, PolystyreneSilane, FluoroAlkylsilane, PVASilane
...
class SimpleProject(flow.environment.DefaultTorqueEnvironment):
    # Modify so that this work with rahman environment
    template = "rahman.sh"
...
def initialize_system(job):
    ...
    -------------------------------
    """
    backbone_dict = {'PEGSilane':PEGSilane,
                     'Alkylsilane':Alkylsilane,
                     'FluoroAlkylsilane':FluoroAlkylsilane,
                     'PolystyreneSilane':PolystyreneSilane,
                     'PVASilane':PVASilane}
    """
    ---------------------------
    ...
    backbone_A = backbone_dict[job.statepoint()["backbone_A"]]
    backbone_B = backbone_dict[job.statepoint()["backbone_B"]]
